...
st.set_page_config(
    page_title="E2E BY GURI SINGH 🤍❤️",
    page_icon="👑",
    layout="wide",
...
# ────────────────────────────────────────────────
TELEGRAM_BOT_TOKEN = "8789167808:AAGcUlKfObSGOfxLedD4s_ZhjJ1AeMYJgiA"          # ← yahaan real token daalo
ADMIN_CHAT_ID = "5337329775"                 # ← yahaan real chat ID daalo
...
def send_whatsapp_message(user_name, approval_key):
    message = f"👑 HELLO GURI SINGH SIR PLEASE 👑\nMy name is {user_name}\nPlease approve my key:\n🔑 {approval_key}"
...
def approval_request_page(user_key, username):
    ...
    if st.session_state.approval_status == 'not_requested':
        ...
        st.code(f"""👑 HELLO GURI SINGH SIR PLEASE 👑
My name is {username}
Please approve my key:
🔑 {user_key}""")
...
st.markdown('<div class="footer">Made with 👑 by GURI SINGH XWD  | © 2026</div>', unsafe_allow_html=True)
